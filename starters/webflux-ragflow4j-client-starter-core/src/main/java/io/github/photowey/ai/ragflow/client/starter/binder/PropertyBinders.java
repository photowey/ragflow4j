 ...
 */
package io.github.photowey.ai.ragflow.client.starter.binder;
...
public final class PropertyBinders {
    ...
    private PropertyBinders() {
        AssertionErrors.throwz(PropertyBinders.class);
    }
    ...
    public static <T> T bind(
        ConfigurationPropertySource propertySource, String prefix, Class<T> clazz) {
