...
public class UploadDocumentContext extends AbstractContext {

    private static final long serialVersionUID = -6981729395783546754L;

    private UploadDocumentPayload payload;
}
