...
public class UpdateDatasetContext extends AbstractContext {

    private static final long serialVersionUID = 4269865065071683630L;

    private UpdateDatasetPayload payload;
}
